...
<head>
    ...
    <title>Error 404 || Brook Multipurpose Bootstrap4 Template</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <!-- Favicon -->
    <link rel="shortcut icon" href="img\favicon.bin" type="image/x-icon">
        ...
        <div class="demo-option-container">
            ...
            <div class="brook__toolbar">
                <div class="inner">
                    ...
                    <a class="hint--bounce hint--left hint--black primary-color-hover-important" target="_blank" href="https://themeforest.net/user/bootxperts/portfolio" aria-label="Purchase Brook">
            ...
            <div class="demo-option-wrapper">
                <div class="demo-panel-header">
                    <div class="panel-btn">
                        <a class="brook-btn bk-btn-theme btn-sd-size btn-rounded space-between" href="cart.html"><i class="ion-android-cart"></i> Buy Brook Now </a>
                    </div>
                    <div class="title">
                        ...
                        <div class="col-lg-12">
                            <div class="error-inner text-center">
                                <div class="image mb--55">
                                    <img src="img\icons\image_404.png" alt="Multipurpose imaages">
                                </div>
                                ...
                                <div class="error-text mt--20">
                                    ...
                                    <div class="error-button-group mt--40">
                                        <a class="brook-btn bk-btn-theme btn-sd-size btn-rounded space-between" href="#">Go
                                            back</a>
                                        <a class="brook-btn bk-btn-white btn-sd-size btn-rounded space-between" href="index.html">Homepage</a>
                                    </div>
                                </div>
                            </div>
                        </div>
